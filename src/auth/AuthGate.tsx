 ...
 *
 * UC-3 wraps a React Router tree; UC-1 has no route table (a two-branch hash
 ...
 * existing credential-free mock/demo build behaves exactly as it does today.
 */
import { useEffect, useState } from 'react';
import { authEnabled, clearSession, getRole, verifySession } from './session';
